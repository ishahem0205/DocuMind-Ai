...
import { AnalysisResult, SimilarityResult } from "../types";

// Use Vite-provided env variable (client-side). Make sure .env.local at project root has VITE_GEMINI_API_KEY.
// Example: VITE_GEMINI_API_KEY=your_key_here
const apiKey = (import.meta.env.VITE_GEMINI_API_KEY as string) || "";

if (!apiKey) {
  console.error("VITE_GEMINI_API_KEY is missing. Add it to .env.local at project root and restart Vite.");
}
